  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold font-display uppercase tracking-[1px] text-foreground">新建文章</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="space-y-6">
          <div className="bg-card rounded-[24px] border border-border p-6 space-y-4">
            <button onClick={() => handleSubmit('PUBLISHED')} disabled={saving || !formData.title} className="w-full bg-primary text-primary-foreground py-2 rounded-[24px] hover:bg-primary/90 font-mono uppercase text-sm tracking-[1px] transition-colors disabled:opacity-50">发布</button>
            <button onClick={() => handleSubmit('DRAFT')} disabled={saving || !formData.title} className="w-full bg-card/50 text-foreground py-2 rounded-[24px] hover:bg-hover font-mono uppercase text-sm tracking-[1px] transition-colors disabled:opacity-50">保存草稿</button>
